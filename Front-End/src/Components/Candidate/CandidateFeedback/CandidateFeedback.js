...
const CandidateFeedback = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="candidate-feedback-main">
        ...
        {manageFeedbackActive && (
          <div className="manage-feedback">
            ...
            <div className="candidate-sent-feedbacks">
              <h2>Sent Feedbacks</h2>
              {feedbacksSent.map((feedback) => (
                <div key={feedback.id} className="candidate-feedback-item">
            ...
            <div className="candidate-received-feedbacks">

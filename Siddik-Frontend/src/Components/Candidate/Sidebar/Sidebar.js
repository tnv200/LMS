...
const Sidebar = ({ sidebarOpen, closeSidebar, isAssessmentInProgress }) => {
  const sidebarStyle = {
    cursor: isAssessmentInProgress ? "not-allowed" : "pointer",
  ...
  return (
    ...
    >
      ...
      <div className="bottom-div"><div class="social-card">
        <a
          class="socialContainer containerOne"
          href="https://www.instagram.com/torryharrisintegrationsolution?igsh=MWF6NGgwZ2gwNnhnZQ=="
          target="_blank"
        >
        ...
        <a
          ...
          href="https://twitter.com/torryharris"
          target="_blank"
        >
        ...
        <a
          ...
          href="https://www.facebook.com/TorryHarrisIntegrationSolutions/"
          target="_blank"
        >
          <svg height="1em" viewBox="0 0 320 512" class="socialSvg facebookSvg">
